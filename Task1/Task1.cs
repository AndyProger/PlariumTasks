namespace PlariumTasks
{
    class Task1
    {
         ...
         */
        static public decimal[] IncreaseAmount(decimal amount, decimal percent)
        {
            var incrementAmounts = new decimal[10];
         ...
         */
        static public decimal[] DepositAmount(decimal amount, decimal percent)
        {
            var incrementAmounts = new decimal[10];
